...
// Apply CSS using JavaScript after elements are created
var dashboard = document.querySelector('.view-dashboard');
      dashboard.style.marginTop = '20px';
      dashboard.style.fontSize = '16px';
  
      var dashboardLink = document.querySelector('.view-dashboard a');
      dashboardLink.style.color = 'black';
      dashboardLink.style.textDecoration = 'none';
  
      dashboardLink.addEventListener('mouseover', function() {
        dashboardLink.style.color = '#555';
      });
